...
const BentoCard = ({ src, title, description }) => {
    ...
    // Lazy-load videos only when they appear in viewport
    useEffect(() => {
        ...
        <section id="features" className="bg-black pb-52">
            <div className="container mx-auto px-3 md:px-10">
                <div className="px-5 py-32">
                    ...
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50 mt-2">
                ...
                <BentoTilt className="border-hsla relative mb-7 h-96 overflow-hidden w-full rounded-md md:h-[65vh]">
                    <BentoCard
